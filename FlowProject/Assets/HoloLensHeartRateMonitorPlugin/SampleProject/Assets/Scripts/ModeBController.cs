...
/*
 * Mode B uses a producer/consumer pattern to retrieve new values from the plugin.  
 */
// heart image source: https://commons.wikimedia.org/wiki/File:Heart_icon_red_hollow.svg

public class ModeBController : MonoBehaviour
{
    ...
    private void onConnectClicked()
    {
        ...
        // Mode B: connect with Queue/Action Producer/Consumer pattern
    ...
    void Update()
    {
        // Mode B: Check queue for new Actions added by the plugin
